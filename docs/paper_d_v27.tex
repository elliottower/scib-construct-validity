...
\toprule
Metric & Spearman $\rho$ & $p_{\text{BH}}$ & Pairwise & Kendall $\tau$ & $p_{\text{BH}}$ \\
\midrule
SCC              & $+0.733$ & $<0.001$ & 85.7\% & $+0.714$ (21/21) & $<0.001$ \\
MMD              & $+0.704$ & $<0.001$ & 84.1\% & $+0.683$ (20/21) & $<0.001$ \\
CCAL             & $+0.575$ & $<0.001$ & 82.5\% & $+0.651$ (20/21) & $<0.001$ \\
RCS (baseline)   & $+0.252$ & $0.060$  & 68.3\% & $+0.365$ (16/21) & $0.048$  \\
PAD              & $+0.306$ & $0.033$  & 55.6\% & $+0.236$ (12/21) & $0.238$  \\
\bottomrule
\end{tabular}
\end{table}
...
theory---fails pairwise discrimination (55.6\%, $p = 0.45$). PAD
...
transfer-aware metric computation. SHA-256 hashes and the full deviation log are in the online
repository.
...
\paragraph{Results.} Three metrics pass the primary criterion: SCC
(21/21 positive $\tau$, BH $p < 0.001$), MMD (20/21, BH $p < 0.001$),
and CCAL (20/21, BH $p < 0.001$). RCS-baseline and RCS-trimmed pass
marginally (16--17/21, BH $p < 0.05$). RCS-PCA10, RCS-normalized, and
PAD fail. Full results in Table~\ref{tab:scc}.
