# Preflight Bio — Experiment Preregistration (v4)

**Status:** DRAFT — pending review before SHA freeze  
**Date:** 2026-07-10  
**Author:** Elliot Tower  
**Reviewer:** (Perplexity / external)  
**Changes from v3:** 2 final fixes — (1) H0.2/H0.3 minimum bin-size gate (≥4 pairs per tier bin), (2) H0.1b rationale corrected for partial-vs-raw estimator inconsistency.  
**Changes from v2:** 5 fixes from Perplexity review — relative degradation, shifted-pairs-only, partial-ρ threshold, within-group ρ, M2-specific comparison.
