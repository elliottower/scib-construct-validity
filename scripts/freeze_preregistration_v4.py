#!/usr/bin/env python3
"""Freeze preregistration SHA-256 for all 6 experiments in preregistration_v4.

Computes one SHA per experiment (different dataset specs, same scorer code).
Saves JSON records to docs/frozen_prereg_v4/.
"""
import json
import subprocess
...
OUTPUT_DIR = Path("docs/frozen_prereg_v4")
...
summary = {
    ...
    "preregistration_doc": "docs/preregistration_v4.md",
