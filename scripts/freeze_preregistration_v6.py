#!/usr/bin/env python3
"""Freeze preregistration SHA-256 for all 6 experiments (v6: M4/M6/M3 bug fixes).

Computes one SHA per experiment (different dataset specs, same scorer code).
Saves JSON records to docs/frozen_prereg_v6/.
"""
import json
import subprocess
...
OUTPUT_DIR = Path("docs/frozen_prereg_v6")
